...
def test_signatures(tmpdir, package, digestcheck):
    ...
    assert 'W: cron-file-symlink /etc/cron.daily/test-me-symlink' in out
    assert 'W: dbus-file-symlink /etc/dbus-1/system.d/test-me-symlink-broken broken symlink' in out
